...
1. <a href='#step-1-create-a-sandbox-account-and-obtain-an-api-key'> Create a sandbox account and obtain an API key.</a>
2. <a href='#step-2-play-in-the-sandbox-with-your-api-keys'>Play in the sandbox with your API keys.</a>
    * <a href='#basic-get-call'>Basic example: GET language pairs</a>
    * <a href='#basic-post-call'>Basic example: POST to translate/jobs</a>
...
<a href='http://sandbox.mygengo.com/sandbox'>Create a sandbox account</a>
...
The return values are the IDs for each job. With these IDs you can retrieve the status of the job. Let's use the example script for retrieving a specific job to get the status of job [XX] we just submitted:
